...
Acht Schichten tragen den Bereich. Fünf davon hängen als **Anlagen** an
...
#: Dahinter der Städtevergleich, denn der verlässt Oldenburg ganz.
#:
#: Zwei Zeilen und nicht eine, obwohl beide aus derselben Tabelle kommen: Die
#: Jahresangaben bedeuten Verschiedenes — beim Finanzausgleich ist es das
#: **Ausgleichsjahr** (läuft dem Kalender voraus), beim Realsteuervergleich
#: das **Berichtsjahr** (hinkt ihm nach). Zusammengelegt ergäbe das eine
#: Spanne „2023–2026", in der zwei verschiedene Dinge dasselbe zu meinen
#: scheinen — genau die Verwechslung, gegen die die eigene Tabelle des
#: Städtevergleichs angelegt wurde (s. Kopf von ``council/staedtevergleich``).
