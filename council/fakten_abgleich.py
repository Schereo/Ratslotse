...
**Zwei Nutzer** (seit 24.09.2026): die Fakten-Eval (``eval/run_fakten.py``)
und Lottis Selbstprüfung (``council/self_check.py``, Stufe 1). Deshalb liegt
das Modul unter ``council/`` — ``eval`` darf von hier importieren, ``council``
nicht aus ``eval`` (``tests/test_schichten.py``).
