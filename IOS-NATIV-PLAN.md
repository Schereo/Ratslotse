...
| Admin | Für Admin-Konten sind Statistik, Feedback, LLM-Kosten, Nutzerverwaltung, Quizmoderation, Ortsprüfung und Themen-Dubletten nativ verfügbar und an dieselben geschützten Backend-Endpunkte gebunden. | Funktional gleich; große Tabellen werden auf iOS als adaptive Karten und auf dem iPad als Raster dargestellt. |
