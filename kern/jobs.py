...
JOBS: list[dict] = [
    ...
    },
    {
        ...
        "description": "Schneidet die Ratssitzung live aus dem O1-Stream mit, verfolgt dabei, welcher TOP gerade läuft und wer spricht (Live-Karte), und liest die Abstimmungsergebnisse noch am Sitzungsabend — an Tagen ohne Ratssitzung ein Leerlauf.",
