...
let sheets = [
    ...
    .init(source: "lotti-gesten.png", sourceColumns: 13, start: 0, count: 18, asset: "LottiSpriteCelebrate"),
    .init(source: "lotti-gesten.png", sourceColumns: 13, start: 18, count: 16, asset: "LottiSpriteAmazed"),
    .init(source: "lotti-gesten.png", sourceColumns: 13, start: 34, count: 24, asset: "LottiSpriteWave"),
    .init(source: "lotti-zustaende.png", sourceColumns: 14, start: 0, count: 21, asset: "LottiSpriteThinking"),
    .init(source: "lotti-zustaende.png", sourceColumns: 14, start: 21, count: 20, asset: "LottiSpriteSleeping"),
    .init(source: "lotti-zustaende.png", sourceColumns: 14, start: 41, count: 17, asset: "LottiSpriteShakeHead"),
    .init(source: "lotti-zustaende.png", sourceColumns: 14, start: 58, count: 26, asset: "LottiSpriteSearching"),
    .init(source: "lotti-zustaende.png", sourceColumns: 14, start: 84, count: 19, asset: "LottiSpriteBow"),
    .init(source: "lotti-zustaende.png", sourceColumns: 14, start: 103, count: 12, asset: "LottiSpriteJuggling"),
    .init(source: "lotti-gesten.png", sourceColumns: 13, start: 58, count: 10, asset: "LottiSpritePointRight"),
    .init(source: "lotti-gesten.png", sourceColumns: 13, start: 68, count: 10, asset: "LottiSpritePointLeft"),
    .init(source: "lotti-gesten.png", sourceColumns: 13, start: 78, count: 10, asset: "LottiSpritePointUp"),
    .init(source: "lotti-gesten.png", sourceColumns: 13, start: 88, count: 10, asset: "LottiSpritePointDown"),
    .init(source: "lotti-gesten.png", sourceColumns: 13, start: 98, count: 16, asset: "LottiSpriteLaugh"),
    .init(source: "lotti-gesten.png", sourceColumns: 13, start: 114, count: 12, asset: "LottiSpriteSigh"),
    .init(source: "lotti-gesten.png", sourceColumns: 13, start: 126, count: 18, asset: "LottiSpriteClap"),
    .init(source: "lotti-gesten.png", sourceColumns: 13, start: 144, count: 8, asset: "LottiSpritePointSelf"),
    .init(source: "lotti-zustaende.png", sourceColumns: 14, start: 115, count: 8, asset: "LottiSpriteRaiseHand"),
    .init(source: "lotti-zustaende.png", sourceColumns: 14, start: 123, count: 22, asset: "LottiSpriteExplain"),
    .init(source: "lotti-zustaende.png", sourceColumns: 14, start: 145, count: 18, asset: "LottiSpriteWaiting"),
    .init(source: "lotti-zustaende.png", sourceColumns: 14, start: 163, count: 8, asset: "LottiSpriteSad"),
    .init(source: "lotti-gesten.png", sourceColumns: 13, start: 152, count: 13, asset: "LottiSpriteStartled"),
