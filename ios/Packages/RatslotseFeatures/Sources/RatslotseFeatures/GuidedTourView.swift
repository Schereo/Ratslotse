...
struct GuidedTourView: View {
    ...
    private let steps: [GuidedTourStep] = [
        ...
        .init(id: "analyse", kicker: "Ratsanalyse", title: "Zahlen zum Rat – interaktiv.", text: "Tippe auf Quartale, Parteien und Finanzbalken. Dahinter liegen immer die Beschlüsse, aus denen die Auswertung entstanden ist.", scene: .explain, glyph: .analysis, target: .analysis),
