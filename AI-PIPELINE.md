...
- In Produktion wird die DB **nur durch Live-Scraping** befüllt (`fetch_recent.py`,
  `check_council.py`). Es gibt **kein** Seed-/Import-Kommando, das einen realistischen
  Datensatz (ganze Ausgaben, mehrere Sitzungen) lokal lädt.
