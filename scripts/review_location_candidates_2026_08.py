...
CONCRETE: dict[str, tuple[str, str | None]] = {
    "lindenhofsgarten": ("street", None),
    "kuestenkanal": ("water", None),
    "sperberweg": ("street", None),
    "stadion-maastrichter-strasse": ("facility", None),
    "offizierskasino": ("building", None),
    "esskamp-126": ("building", None),
    "haus-der-jugend": ("building", None),
    "skateanlage-eversten": ("facility", None),
    "schiessstand": ("facility", None),
    "amalienbruecke": ("structure", None),
    "schlosshoefe": ("building", None),
    "zob": ("facility", None),
    "rauhehorst": ("street", None),
    "standesamt": ("building", None),
    "kloster-blankenburg": ("facility", None),
    "buemmersteder-tredde": ("street", None),
    "drielaker-see": ("water", None),
    "baekeplacken": ("street", None),
    "am-festungsgraben": ("street", None),
    "skatehalle-oldenburg": ("building", None),
    "bahnhof": ("building", None),
    "schellenberg": ("street", None),
    "finanzamtsgelaende": ("facility", None),
    "am-tweelbaeker-see": ("street", None),
    "sporthalle-maastrichter-strasse": ("facility", None),
    "westkreuz": ("facility", None),
    "tonkuhle": ("water", None),
    "oldenburger-kompostwerk": ("facility", None),
    "oldenburg-osnabrueck": ("route", "Bahnstrecke Oldenburg–Osnabrück"),
    "am-apfelhof": ("street", None),
    "sport-und-gesundheitsbad-am-floetenteich": ("facility", None),
    "wasserwerk-alexandersfeld": ("facility", None),
    "esskamp-72": ("building", None),
    "olantis": ("facility", "OLantis"),
    "schuetzenweg-34": ("building", None),
    "am-schiessstand": ("street", None),
    "sporthalle-haarenesch": ("facility", None),
    "tiefgarage-am-stadtmuseum": ("structure", None),
    "fahrradstation-nord": ("facility", None),
    "park-und-kramermarktsflaeche": ("facility", None),
    "kunstrasenplatz-ofenerdiek": ("facility", None),
    "altes-gymnasium-oldenburg": ("building", None),
    "bahnuebergang-am-stadtrand": ("structure", None),
    "tiefgarage-cco": ("structure", None),
    "a-293": ("route", None),
    "feldkamp": ("street", None),
    "oldenburg-ost": ("route", "Autobahnkreuz Oldenburg-Ost"),
    "patentbusch": ("street", None),
    "autobahn-a-29": ("route", None),
    "gedenkstein-fuer-wilhelm-den-grossen": ("structure", None),
    "rosa-lazarus-strasse": ("street", None),
    "tami-oelfken-strasse": ("street", None),
    "aeg-motorenwerk": ("facility", None),
    "sportanlage-kennedystrasse": ("facility", None),
    "pflegeeinrichtung-schinkelstrasse": ("building", None),
}
