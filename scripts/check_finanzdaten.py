...
Der Haushalts-Bereich lebt von fünfundzwanzig Datenschichten (``finanzquellen.
...
eigenen Leser mitbringen (``einlesen``). Von den sechzehn übrigen kommen sieben von
außerhalb und haben eigene Wege — ausdrücklich so, denn „lädt nichts herunter"
ist die Regel, an der dieser Job hängt. Die restlichen neun liegen zwar im
...
``ingest_finanzhaushalt.py``, ``ingest_gesellschaft_abschluss.py``). Bis 09/2026 hat
