...
Der Haushalts-Bereich lebt von vierundzwanzig Datenschichten (``finanzquellen.
...
eigenen Leser mitbringen (``einlesen``). Von den fünfzehn übrigen kommen sieben von
außerhalb und haben eigene Wege — ausdrücklich so, denn „lädt nichts herunter"
ist die Regel, an der dieser Job hängt. Die restlichen acht liegen zwar im
...
``ingest_finanzhaushalt.py``). Bis 09/2026 hat
