...
Der Haushalts-Bereich lebt von zweiunddreißig Datenschichten (``finanzquellen.
...
eigenen Leser mitbringen (``einlesen``). Von den dreiundzwanzig übrigen kommen elf von
