...
Der Haushalts-Bereich lebt von sechsundzwanzig Datenschichten (``finanzquellen.
...
eigenen Leser mitbringen (``einlesen``). Von den siebzehn übrigen kommen sieben von
außerhalb und haben eigene Wege — ausdrücklich so, denn „lädt nichts herunter"
ist die Regel, an der dieser Job hängt. Die restlichen zehn liegen zwar im
