...
CREATE TABLE "committee_subscriptions" ( id INTEGER PRIMARY KEY AUTOINCREMENT, owner_id INTEGER NOT NULL, committee_name TEXT NOT NULL, created_at TEXT NOT NULL, UNIQUE(owner_id, committee_name));
...
, attempts INTEGER NOT NULL DEFAULT 0, push_text TEXT);
...
CREATE TABLE qa_gespraech_turns (
    id           INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE user_quiz_questions (
    ...
    created_at    TEXT NOT NULL
, qtype TEXT NOT NULL DEFAULT 'mc', answer_value REAL, answer_unit TEXT, range_min REAL, range_max REAL);
CREATE TABLE users (
    chat_id    INTEGER PRIMARY KEY,
    username   TEXT NOT NULL DEFAULT '',
    added_at   TEXT NOT NULL
);
CREATE TABLE vorlage_follows (
    id          INTEGER PRIMARY KEY AUTOINCREMENT,
    owner_id    INTEGER NOT NULL,
...
CREATE TABLE web_users (
    ...
    created_at       TEXT NOT NULL
, delivery_channel TEXT NOT NULL DEFAULT 'telegram', nwz_fulltext_allowed INTEGER NOT NULL DEFAULT 0, email_verified INTEGER NOT NULL DEFAULT 0, onboarding TEXT, apple_sub TEXT, password_set INTEGER NOT NULL DEFAULT 1, badges TEXT, display_name TEXT, setup_step INTEGER, setup_started_at TEXT, setup_updated_at TEXT, setup_done_at TEXT, setup_reminded_at TEXT, notify_prefs TEXT, qa_speichern INTEGER, deep_limit INTEGER, limits_frei INTEGER NOT NULL DEFAULT 0, topics_seen_at TEXT);
...
CREATE INDEX idx_qa_gespraeche_user ON qa_gespraeche(user_id, updated DESC);
CREATE INDEX idx_qa_turns_gespraech ON qa_gespraech_turns(gespraech_id);
...
CREATE INDEX idx_vorlage_follows_kvonr ON vorlage_follows(kvonr);
