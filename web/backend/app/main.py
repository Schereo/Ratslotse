...
from .routers import account, admin, auth, auth_apple, bookmarks, council, districts, feedback, kommunalwahl, onboarding, push, quiz, social, topics, badges, calendar
