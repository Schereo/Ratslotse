...
def lessons_2014() -> RunoffLessons2014:
    ...
    def nach_staerke(slug: str) -> RunoffCandidateStrength:
        # Jede Kandidatur nach ihrem EIGENEN Anteil sortiert — gleich viele
        # Bezirke je Rand, damit absolute Zugewinne vergleichbar sind.
        ...
        def gruppe(bezirke: list[int]) -> RunoffStrengthGroup:
            ...
            return RunoffStrengthGroup(districts=len(bezirke), first=erste, runoff=zweite, change=zweite - erste,
                                       change_pct=round(100 * (zweite - erste) / max(1, erste), 1))
