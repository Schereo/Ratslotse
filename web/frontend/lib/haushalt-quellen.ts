...
// `standText()`.
//
// `as_of` bleibt für die vier Fälle, die sich NICHT ableiten lassen, und als
...
export function standText(q: Quelle, years: number[] | undefined): string {
  if (q.standWort === undefined || !years || years.length === 0) return q.as_of;
  const von = years[0];
...
export const QUELLEN: Record<QuellenSchluessel, Quelle> = {
  plan: {
    title: "Beschlossener Haushaltsplan der Stadt Oldenburg",
  ...
  taxes: {
    title: "Steuereinnahmen der Stadt Oldenburg seit 1998",
    citation:
  ...
  tax_capacity: {
    title: "Steuerkraftmesszahlen und Schlüsselzuweisungen seit 1993",
    citation:
    ...
    as_of: "Ausgleichsjahre 1993–2026",
    lizenz: "dl-de/by-2.0",
    art: "csv",
  ...
  tax_rates: {
    title: "Realsteuer-Hebesätze der Stadt Oldenburg seit 1980",
    citation:
  ...
  tax_plan: {
    ...
    herausgeber: "Stadt Oldenburg, Fachdienst Geo und Daten",
    standWort: "Haushaltsjahre",
    as_of: "Haushaltsjahre 2023–2025",
    art: "pdf",
    url: "https://www.oldenburg.de/startseite/rathaus/politik-verwaltung/stadtverwaltung/statistik/statistisches-jahrbuch.html",
  },
  ...
  jahresabschluss: {
    title: "Jahresabschlüsse der Stadt Oldenburg",
  ...
  wirtschaftsplan: {
    title: "Wirtschaftspläne der Eigenbetriebe und städtischen Gesellschaften",
    citation:
    ...
    as_of: "Wirtschaftspläne 2019–2026",
    art: "pdf",
    url: "https://buergerinfo.oldenburg.de",
  },
  fees: {
    title: "Gebührenbedarfsberechnungen des Abfallwirtschaftsbetriebs",
    citation:
    ...
    as_of: "Gebührenbedarfsberechnungen 2023–2026",
    art: "pdf",
    url: "https://buergerinfo.oldenburg.de",
  },
  aenderungsliste: {
    title: "Änderungslisten zum Haushaltsentwurf",
    citation:
  ...
  budget_bylaw: {
    ...
    as_of: "Haushaltssatzungen 2019–2026 (Verwaltungsentwürfe)",
    art: "pdf",
    url: "https://buergerinfo.oldenburg.de",
  },
  income_budget: {
    title: "Gesamtergebnishaushalte der Stadt Oldenburg (Planjahre)",
    citation:
  ...
  teilhaushalt: {
    title: "Teilhaushaltspläne der Stadt Oldenburg (Produktebene)",
    citation:
    ...
    herausgeber: "Stadt Oldenburg, Controlling und Finanzen",
    standWort: "Haushaltsjahre",
    as_of: "Haushaltsjahre 2018–2025",
    art: "pdf",
    url: "https://buergerinfo.oldenburg.de",
  },
  stellenplan: {
    title: "Stellenpläne der Stadt Oldenburg",
    citation:
  ...
  pruefbericht: {
    title: "Schlussberichte des Rechnungsprüfungsamtes der Stadt Oldenburg",
    citation:
  ...
  gesamtabschluss: {
    title: "Konsolidierte Gesamtabschlüsse der Stadt Oldenburg",
    citation:
    ...
    as_of: "Gesamtabschlüsse 2014–2024",
    art: "pdf",
    url: "https://buergerinfo.oldenburg.de",
  },
  reserves: {
    title: "Überschussrücklage aus den Jahresabschlüssen",
    citation:
    ...
    herausgeber: "Stadt Oldenburg, Controlling und Finanzen",
    standWort: "Jahresabschlüsse",
    as_of: "Jahresabschlüsse 2017–2024; bestätigt im genehmigten Haushalt 2026",
    art: "pdf",
  ...
  population: {
    title: "Einwohnerzahlen der Stadt Oldenburg je Haushaltsjahr",
    citation:
    ...
    herausgeber: "Stadt Oldenburg, Open-Data-Portal",
    standWort: "Haushaltsjahre",
    as_of: "Haushaltsjahre 2010–2025",
    lizenz: "dl-de/by-2.0",
    art: "csv",
  ...
  ergebnisrechnung_thh: {
    title: "Ergebnisrechnung je Teilhaushalt (Jahresabschlüsse)",
    citation:
  ...
  cash_flow_statement: {
    title: "Finanzrechnung der Kernverwaltung (Jahresabschlüsse)",
    citation:
  ...
  bilanz: {
    title: "Bilanz der Stadt Oldenburg (Jahresabschlüsse)",
    citation:
    ...
    as_of: "Bilanzstichtage 2016–2024",
    art: "pdf",
    url: "https://buergerinfo.oldenburg.de",
  },
  indicators: {
    title: "Kennzahlenübersicht der Rechenschaftsberichte",
    citation:
    ...
    as_of: "Rechenschaftsberichte 2019–2024",
    art: "pdf",
    url: "https://buergerinfo.oldenburg.de",
  },
  ratsbeschluss: {
    title: "Sitzungen, Vorlagen und Beschlüsse des Rates (Bürgerinformationssystem)",
    citation:
    ...
    as_of: "Sitzungen seit Januar 2018",
    art: "web",
    url: "https://buergerinfo.oldenburg.de",
  },
  ...
  lsn_finanzausgleich: {
    title: "Kommunaler Finanzausgleich in Niedersachsen — Vergleichstabellen",
    citation:
    ...
    as_of: "Ausgleichsjahr 2026 (endgültig, Stand 26.03.2026)",
  ...
  lsn_realsteuern: {
    title: "Realsteuervergleich Niedersachsen",
    citation:
    ...
    herausgeber: "Landesamt für Statistik Niedersachsen",
    as_of: "Berichtsjahr 2025 (korrigierte Fassung vom 30.07.2026)",
    lizenz: "Vervielfältigung mit Quellennachweis gestattet",
    art: "csv",
  ...
  lsn_gewerbesteuer: {
    title: "Gewerbesteuerstatistik Niedersachsen",
    citation:
    ...
    as_of: "Erhebungsjahr 2021 (Statistischer Bericht L IV 13, erschienen im März 2026)",
    lizenz: "Vervielfältigung mit Quellennachweis gestattet",
    art: "csv",
  ...
  vergleich_2018: {
    title: "Personalentwicklung seit dem Jahr 2000 — Antrag der FDP-Fraktion und Antwort der Verwaltung",
    citation:
  ...
  gebaut: {
    ...
    as_of: "2003–2025 (Ausgabe vom 08.07.2026)",
    art: "pdf",
    url:
  ...
  schulden: {
    title: "Statistisches Jahrbuch der Stadt Oldenburg, Tabelle 1108 — Stand der Verschuldung",
    citation:
    ...
    standWort: "",
    standZusatz: "(Ausgabe vom 08.07.2026)",
    as_of: "1995–2025 (Ausgabe vom 08.07.2026)",
    art: "pdf",
    url:
      "https://www.oldenburg.de/fileadmin/oldenburg/Benutzer/Dateien/" +
  ...
  expense_series: {
    ...
    as_of: "Haushaltsjahre 1972–2025 (Jahrbuch-Ausgabe vom 08.07.2026)",
    lizenz: "dl-de/by-2.0",
    art: "pdf",
    url:
      "https://www.oldenburg.de/fileadmin/oldenburg/Benutzer/Dateien/" +
  ...
  // keine haben.
  investitionen: {
    title: "Finanzhaushalt der Stadt Oldenburg — Investitionen je Teilhaushalt",
    citation:
  ...
  investitionsprogramm: {
    title: "Investitionsprogramm zum Haushaltsplan (Anlage 004)",
    citation:
    ...
    herausgeber: "Stadt Oldenburg, Ratsinformationssystem",
    standWort: "Haushaltsjahre",
    as_of: "Haushaltsjahre 2019–2026",
    art: "pdf",
    url: "https://buergerinfo.oldenburg.de/getfile.php?id=297440&type=do",
  },
  beteiligungsbericht: {
    title: "Beteiligungsbericht der Stadt Oldenburg (§ 151 NKomVG)",
    citation:
