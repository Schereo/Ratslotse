      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="rounded-2xl border border-border bg-card p-4 shadow-sm sm:p-5">
          ...
          <p className="mt-3 border-t border-dashed border-border pt-2.5 text-[11.5px] leading-relaxed text-muted-foreground">
            Sortiert nach Ausgaben, nicht nach der Nummer im Haushaltsplan
            <Beleg q="plan" />. Die Beschreibungen sind redaktionell nach dem Vorbericht
            des Plans — keine amtliche Gliederung.
          </p>
        </div>
