    ...
    <div className="space-y-5">
      <div className="relative max-w-md">
        ...
        <input
          ...
          className="h-9 w-full rounded-[10px] border border-input bg-card pl-9 pr-3 text-base sm:text-sm text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        />
      </div>
      {groups.map((label) => {
