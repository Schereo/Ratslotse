...
export const metadata: Metadata = {
  ...
  description:
    "Ratslotse macht die Beschlüsse des Oldenburger Stadtrats durchsuchbar, vergleichbar und verständlich — mit Fragen in eigenen Worten, Themen-Seiten, Karten und Analysen.",
