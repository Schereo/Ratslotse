        ...
        <div className="mt-6 space-y-6">
          ...
          <Section title="Empfänger / Auftragsverarbeiter">
            ...
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li><strong>KI-Verarbeitung (OpenRouter):</strong> „Frag den Rat"-Anfragen werden zur Beantwortung an einen externen KI-Dienst übermittelt; dabei kann eine Übermittlung in ein Drittland erfolgen. <strong>Bitte gib keine personenbezogenen oder sensiblen Daten in die Fragen ein.</strong> Private Problemmeldungen werden im aktuellen Ausbaustand nicht an OpenRouter oder einen anderen externen KI-Anbieter gesendet.</li>
