  ...
  return (
    <div>
      ...
      <svg viewBox={`0 0 ${W} ${H}`} className="block w-full" role="img"
        ...
        <text x={x(letzter.jahr) + 12} y={y(letzter.ein) + 4} fontSize={11} fontWeight={600} style={{ fill: "var(--hh-ein-0)" }}>ein</text>
        <text x={x(letzter.jahr) + 12} y={y(letzter.aus) + 4} fontSize={11} fontWeight={600} style={{ fill: "var(--hh-aus-0)" }}>aus</text>
