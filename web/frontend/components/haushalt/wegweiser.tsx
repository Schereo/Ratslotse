...
//
//  * **Die Schulden stehen am Ende des Rahmens (Schritt 10), nicht bei den
...
// Seite trug bis dahin Schritt 7. Aus demselben Grund hängt die
// Schulden-Seite HINTER dem Städtevergleich und nicht zwischen ihm und dem
