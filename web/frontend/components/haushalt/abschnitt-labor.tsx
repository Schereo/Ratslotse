...
// Das Haushalts-Labor — der DRITTE Abschnitt von /haushalt/mitreden.
//
// Bis zum 21.08.2026 die eigene Seite /haushalt/labor: 78 Zeilen, die eine
// Komponente einbetteten. Als eigener Schritt im Wegweiser stand damit ein
// Element neben achtzehn Seiten. Es gehört zu „Mitreden" — wann entschieden
// wird, worüber gestritten wurde, und was sich drehen ließe.
...
import { HaushaltAuswahl, haushaltUrl, ProdukteAntwort } from "@/lib/haushalt";
...
// `hebesaetze` kam am 21.08.2026 dazu: Der geltende Gewerbesteuer-Satz stand
// im Labor als Konstante (439) und wurde trotzdem als Quelle zitiert — er
...
export function LaborAbschnitt() {
