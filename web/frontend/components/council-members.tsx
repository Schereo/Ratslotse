  ...
  return (
    <div className="space-y-4">
      <div className="rounded-lg border border-border bg-muted/40 p-3 text-xs leading-relaxed text-muted-foreground">
        ...
        wie präsent. Protokolle nennen selten namentliche Einzelstimmen — daher zählt hier die <span className="font-medium text-foreground">Präsenz</span>, nicht das Stimmverhalten.
      </div>
