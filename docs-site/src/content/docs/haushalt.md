...
**Achtundzwanzig** Datenschichten, jede einmal von Hand eingelesen — ohne Cron
veraltet der ganze Bereich still, sobald niemand mehr daran denkt.
`check_finanzdaten.py` (sonntags) nimmt das ab: **Neun** liest er
selbst nach (sie liegen als Anlage im Ratsinformationssystem), die **neunzehn**
übrigen werden nur beobachtet — er meldet, dass ein Jahrgang fällig wäre, und
nennt Quelle und Skript. Acht davon kommen von außerhalb, elf liegen zwar
